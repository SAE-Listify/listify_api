...
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (9, 1, 'Menage', 0, '2023-12-22', 'Femme');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (10, 1, 'Cuisine', 0, '2023-12-22', 'Femme');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (11, 2, 'Devoirs', 0, '2023-12-22', 'Thomas');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (12, 2, 'Reviser', 0, '2023-12-22', 'Thomas');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (13, 3, 'Ranger', 1, '2023-12-18', 'Jules');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (14, 3, 'Faire les courses', 1, '2023-12-18', 'Jules');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (15, 4, 'Tache 1', 0, '2023-12-22', 'Louis');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (16, 4, 'Tache 2', 0, '2023-12-22', 'Louis');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (17, 5, 'Tache 3', 0, '2023-12-22', 'Mass');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (18, 5, 'Tache 4', 1, '2023-12-18', 'Mass');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (19, 6, 'TAche 5 ', 1, '2023-12-18', 'Rayne');
INSERT INTO listify_bdd.task (task_id, repository_id, name, completed, date, owner) VALUES (20, 6, 'Tache 6', 1, '2023-12-18', 'Rayane');
